...
import ValidCreditsModal from "./components/ValidCreditsModal";
import type {
  ICreditConfigFields,
  ICreditPackage,
  ICreditTransaction,
...
const CreditsPage = () => {
  ...
  const summary = useMemo(() => summarizePackages(packages), [packages]);
  ...
  const transactionColumns: ColumnsType<ICreditTransaction> = useMemo(
    () => [
      {
