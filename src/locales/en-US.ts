...
e. Post Your Job for Free: There's no cost to post your vacancies and start discovering exceptional talent.`,
  ...
  member_team: {
    ...
    memberCreateFailed: "Failed to create staff",
    memberUpdateSuccess: "Staff information updated successfully",
    memberUpdateFailed: "Failed to update staff information",
