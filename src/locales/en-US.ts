...
export default {
  ...
  chat: {
    ...
    invite_collaborators_cta: "Invite collaborators",
    invite_btn: "Invite",
    reply_group: "Message the group…",
    cannot_mention_viona_while_thinking:
      "Viona is still thinking. Remove @Viona or wait until she finishes.",
    mention_empty: "No one else to mention",
    ...
    invite_collaborators: {
      ...
      hint: "Share this link with collaborators. Anyone who opens it will need to enter a name and wait for your approval before joining the conversation.",
      copy_link: "Copy link",
      copied_btn: "Copied",
      copied: "Link copied",
      refresh_link: "Refresh link",
      refreshed: "Link refreshed",
      refresh_failed: "Failed to refresh link",
      done: "Done",
    },
    intake_members: {
      in_conversation: "{{count}} in conversation",
      role_owner: "Owner",
      role_ai: "AI",
      ...
      remove_content: 'Remove "{{name}}" from this conversation?',
...
We go through the role in detail: responsibilities, requirements, how to pitch it to candidates. **The depth makes my sourcing and screening much more accurate**, so I strongly recommend it.

**2. Fast** (~10 min):
A quick brief. I work from your materials, ask a few key questions, and confirm the requirements. Fine for straightforward roles or ones you've already scoped in detail.`,
    intake_mode_standard_button: "Standard (~20 min)",
    intake_mode_fast_button: "Fast (~10 min)",
    edit_profiles_hint:
...
e. Post Your Job for Free: There's no cost to post your vacancies and start discovering exceptional talent.`,
  ...
  dashboard: {
    ...
    open_jobs: "Open Jobs",
    open_jobs_tooltip:
      "Published jobs visible to you. Not affected by the Application date filter.",
    pending_intake: "Pending Intake",
    applications: "Applications",
    responded: "AI Screening Responded",
    responded_tooltip: "Includes both in-progress and completed",
    completed: "AI Screening Completed",
    results: "AI Screening Results",
    results_tooltip: "Includes only Completed",
    maybe_or_above: '"Maybe" or above',
    rejected: "Rejected",
    ...
    trends_empty: "Select at least one metric to display",
    by_team: "Applications by Team",
    by_job: "Applications by Job",
    by_job_hint: "(Top 10 most recently posted)",
    filter_departments: "Filter Departments",
    filter_departments_placeholder: "Select departments",
    team_direct_tooltip:
      "Counts only jobs directly assigned to this team. Sub-teams are not aggregated into their parent.",
    col_team: "Team",
    col_job: "Job",
  ...
  job_settings: {
    ...
    add_collaborator_placeholder: "Add Collaborator...",
    role_owner: "Owner",
    role_recruiter: "Recruiter",
    role_hiring_manager: "Hiring Manager",
    add: "Add",
  ...
  talent_details: {
    ...
    download_resume_in: "Download Resume in",
    download_resume_original: "Original",
  ...
  member_team: {
    ...
    rename: "Rename",
    delete: "Delete",
    addChildModalTitle: "Create Team",
    renameModalTitle: "Rename Team",
    nodeName: "Team name",
    nodeNamePlaceholder: "Enter name",
    nodeNameRequired: "Name is required",
    confirm: "OK",
    cancel: "Cancel",
    teamCreateSuccess: "Created",
    teamCreateFailed: "Create failed",
    renameSuccess: "Renamed",
    renameFailed: "Rename failed",
    deleteTitle: "Delete Team",
    deleteConfirm:
      'Delete "{{name}}"? Only Teams without Members or sub-Teams can be deleted.',
    deleteSuccess: "Deleted",
    deleteFailed: "Only Teams without Members or sub-Teams can be deleted.",
    teamUpdateSuccess: "Order updated",
    teamUpdateFailed: "Update failed",
    ...
    orgNodePlaceholder: "Select team for this user",
    orgNodeRequired: "Please select a team",
    visibilityScope: "Visibility (Team scope)",
    visibilityPlaceholder: "Teams visible to this Recruiter",
    update: "Update",
    ...
    staffExists: "Member already exists",
    memberCreateFailed: "Failed to create member",
    memberUpdateSuccess: "Member information updated successfully",
    memberUpdateFailed: "Failed to update member information",
    deactivateConfirmTitle: "Are you sure you want to deactivate {{name}}?",
    deactivateConfirmDesc:
      "This account will no longer be able to sign in or post jobs.",
    activateSuccess: "Account activated",
    deactivateSuccess: "Account deactivated",
    toggleStatusFailed: "Operation failed, please try again later",
    loginInfoTemplate:
  ...
  admin_credit_configs: {
    ...
    newPageTitle: "New Custom Config",
    editPageTitle: "Edit Config",
    ...
    override: "Overridden",
    loading: "Loading...",
    duplicateTitle: "Duplicate Config",
    duplicatePlaceholder: 'e.g. "VIP Customers (Copy)"',
    deleteConfirm: "Delete this config?",
    unsavedTitle: "Leave without saving?",
    unsavedContent: "You have unsaved changes. Leave this page anyway?",
    remarkPlaceholder: "Remark (optional)",
    defaultAppliedHint: "All employers not assigned to any custom config",
    selectEmployers: "Select employers",
    tabs: {
  ...
  admin_mcf_jobs: {
    ...
    table: {
      ...
      category: "Category",
      region: "Region",
      newPostingDate: "New Posting Date",
    ...
    filters: {
      ...
      companyName: "Company Name",
      isPostedOnBehalf: "Posted On Behalf",
      newPostingDate: "New Posting Date",
      filter: "Filter",
      clear: "Clear",
    },
