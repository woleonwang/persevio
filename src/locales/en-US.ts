...
e. Post Your Job for Free: There's no cost to post your vacancies and start discovering exceptional talent.`,
  ...
  job_talents: {
    ...
    status_pending_interview: "Pending Interview",
    status_pending_candidate_confirm: "Pending Candidate Confirmation",
  ...
  company_talents: {
    ...
    job_name_column: "Job Title",
    source_channel_column: "Source",
    apply_time_column: "Date of Application",
    match_level_column: "Match Level",
