...
e. Post Your Job for Free: There's no cost to post your vacancies and start discovering exceptional talent.`,
  ...
  signup: {
    ...
    prev: "Previous step",
    role_type_engineering_tech: "Engineering/Tech",
    role_type_data_ai: "Data/AI",
    role_type_product: "Product",
    role_type_design_ux: "Design/UX",
    role_type_sales: "Sales",
    role_type_marketing_growth: "Marketing/Growth",
    role_type_customer_success_support: "Customer Success/Support",
    role_type_operations: "Operations",
    role_type_finance: "Finance",
    role_type_hr_people: "HR/People",
    role_type_legal_compliance: "Legal/Compliance",
    role_type_it_security: "IT/Security",
    role_type_supply_chain_procurement: "Supply Chain/Procurement",
    role_type_manufacturing: "Manufacturing",
    role_type_facilities: "Facilities",
    role_type_medical_clinical: "Medical/Clinical",
    role_type_other: "Other",
    company_size: "Company Size",
    please_enter_company_size: "Please select company size",
    company_size_1: "1-10",
    company_size_2: "11-50",
    company_size_3: "51-100",
    company_size_4: "101-500",
    company_size_5: "501-1000",
    company_size_6: "1000+",
    signin_with_google: "Sign in with Google",
    signup_with_email: "Sign up with email",
    agree_terms_warning: "Please agree to the terms of service and privacy policy",
    agree_terms_text: "By signing in, you are agreeing to the Terms of Service and Privacy Policy",
  },
