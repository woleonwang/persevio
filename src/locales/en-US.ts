...
e. Post Your Job for Free: There's no cost to post your vacancies and start discovering exceptional talent.`,
  ...
  job_talents: {
    ...
    logistics_fit_options: {
      no_issues: "No Issues",
      location_mismatch: "Location Mismatch",
      work_arrangement_mismatch: "Work Arrangement Mismatch",
      travel_constraint: "Travel Constraint",
  ...
  job_details: {
    ...
    pipeline_section: {
      ...
      all_fit_levels: "All Interview Recommendations",
      rank_by: "Rank by",
      list: "List",
      kanban: "Kanban",
