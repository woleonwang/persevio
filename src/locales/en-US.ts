const CandidateResume = {
  ...
  job_apply: {
    ...
    interview_arrangement: {
      confirm_success: "Interview time confirmed successfully",
      confirm_failed: "Interview time confirmation failed",
      interview_starting_on: "{{count}} interview starting on",
      morning: "Morning",
      afternoon: "Afternoon",
    },
  },
...
e. Post Your Job for Free: There's no cost to post your vacancies and start discovering exceptional talent.`,
  ...
  job_talents: {
    ...
    evaluate_result_options: {
      ...
      good_fit: "Good Fit",
      ideal_candidate_with_caveat: "Ideal Candidate, But {{caveat}}",
      good_fit_with_caveat: "Good Fit, But {{caveat}}",
      maybe: "Maybe — Consider if Pipeline Thin",
      not_a_fit: "Not a Fit",
    },
    evaluate_result_select_options: {
      ideal_candidate: "Ideal Candidate",
      good_fit: "Good Fit",
      ideal_candidate_with_caveat: "Ideal Candidate with Caveat",
      good_fit_with_caveat: "Good Fit with Caveat",
      maybe: "Maybe",
      not_a_fit: "Not a Fit",
    },
  ...
  signup: {
    ...
    role_type: "What kind of roles are you hiring for?",
    headcount_number:
      "How many headcounts are you looking to hire in the next 3-6 months?",
    please_enter_role_type: "Please select role type",
    please_enter_headcount_number: "Please select headcount number",
    headcount_number_placeholder: "Please select headcount number",
    prev: "Previous step",
    role_type_options: {
    ...
    please_enter_company_size: "Please select company size",
    ...
    agree_terms_text:
      "By signing in, you are agreeing to the Terms of Service and Privacy Policy",
  },
  ...
  staffPasswordReset: {
    ...
    forgotSubmitOk:
      "If this email is registered as a staff account, you will receive a password reset email.",
    resetOk: "Your password has been reset",
    newPassword: "New password",
    confirmPassword: "Confirm password",
    pleaseConfirm: "Enter new password again",
    passwordMismatch: "The two passwords do not match",
    minPassword: "Password must be at least 6 characters",
    submitForgot: "Send reset email",
    resendAfter: "Resend in {{seconds}}s",
    tooFrequent: "Too many requests. Please try again in one minute.",
    submitReset: "Reset password",
    backToSignin: "Back to sign in",
    goForgot: "Request reset again",
    ...
    resetFailedTryLater: "Reset failed. Please try again later.",
  },
  ...
  job_details: {
    ...
    pipeline_section: {
      ...
      view_interview_info: "View Interview Info",
      reject: "Reject",
      move_stage_modal_title: "Move Stage",
      fit_high: "High",
      fit_medium: "Medium",
      fit_low: "Low",
      actions: "Actions",
      ...
      uploading_resume: "Uploading and parsing resume...",
      resume_upload_success: "Resume parsed successfully",
      parse_resume_failed: "Failed to parse resume",
      please_upload_resume_first: "Please upload a resume first",
      field_name: "Name",
      field_email: "Email",
      field_phone: "Phone",
    ...
    sourcing_channels_section: {
      ...
      source_name_placeholder: "e.g. Indeed",
    ...
    outreach_campaigns_table: {
      ...
      reached_out_status: "Reached Out",
    ...
    analytics_section: {
      ...
      detailed_stage_breakdown: "Detailed Stage Breakdown",
      stage: "Stage",
  ...
  job_settings: {
    ...
    apply_inbound_email: "Virtual Email (Receive job applications)",
    copy: "Copy",
    copy_success: "Copied",
    copy_failed: "Copy failed",
  ...
  admin_talents: {
    ...
    drawer: {
      outreachMessageReport: "Outreach Message Report",
      accept: "Accept",
      reject: "Reject",
      accepted: "Accepted",
      rejected: "Rejected",
  ...
  staffs: {
    ...
    emailPlaceholder: "Enter staff email",
    ...
    copyLoginInfo: "Copy Login Info",
    successTitle: "Account Created Successfully",
    successMessage:
      "Account created successfully. You can copy the login information and send it to the user for login.",
    copySuccess: "Account information copied to clipboard",
  ...
  groups: {
    ...
    staffPlaceholder: "Select staffs",
  ...
  admin_jobs: {
    ...
    filters: {
      ...
      jobNamePlaceholder: "Filter by job name",
      isPostedPlaceholder: "Filter by posted status",
    },
    table: {
      id: "ID",
      jobName: "Job Name",
      ...
      employerCandidateCount: "Employer Candidate Count",
      passedScreeningCount: "Passed Screening Count",
      confirmedInterviewCount: "Confirmed Interview Count",
    ...
    recommendedCandidates: {
      ...
      candidate: "Candidate",
      pushTime: "Push Time",
      recommendToCandidate: "Recommend to Candidate",
    ...
    bonusPoolModal: {
      ...
      cancel: "Cancel",
      description:
        " Once the bonus pool amount is confirmed, this job will become eligible for recommendations. When a candidate is hired, all users in the referral chain will share the bonus pool.",
  ...
  interview_form: {
    ...
    job_title: "Job Title",
    interview_mode: "Interview Mode",
    select_mode_required: "Please select interview mode",
    written_test_link: "Written Test Link",
    enter_link_required: "Please enter written test link",
    interview_type: "Interview Type",
    select_type_required: "Please select interview type",
    interview_duration: "Interview Duration",
    enter_duration_required: "Please enter interview duration",
    slots_gap: "Gap Between Slots",
    enter_gap_required: "Please enter gap between slots",
