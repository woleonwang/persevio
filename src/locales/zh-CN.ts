...
e. 免费发布职位：您可以免费发布职位空缺，开始发现卓越人才，无需任何费用。`,
  ...
  job_requirement_form: {
    ...
    percentage_options: {
      ...
      project: "项目/目标管理：负责独立或协作推动一个完整的项目从启动到交付，或达成一个具体的业务目标，需要跨职能协调与资源整合。",
      team_management: "管人/管团队：对一整个团队的最终工作结果负责。负责团队的日常管理、人才培养、绩效评估、招聘与激励，确保团队协同高效地达成目标。",
      strategy: "设计高层战略和工作计划：负责或深度参与公司或某个业务线中长期发展战略、业务计划的讨论、制定与落地。",
    },
    
    influence_options: {
      task_level: "任务执行层面影响：这个职位的影响仅限于分配给他们任务，其成功标准是**任务的完成质量和效率**。",
      project_level: "项目层面影响：此职位是特定项目成功的关键贡献者或负责人，其工作质量直接决定**项目能否按时、按质、按预算交付**。",
      team_level: "团队级影响：此职位是其所在团队的整体业绩和目标的负责人或核心贡献者，其产出将显著影响**团队是否能达成其工作目标**。",
      cross_functional: "跨团队/部门协同级影响：此职位需要主导或协调多个团队/整个部门的合作，其工作成效直接关系到**跨团队协同的效率和部门整体目标的实现**。",
      business_level: "业务线/产品线级别：此职位的决策和成果将直接塑造某一产品线或业务线的市场表现和商业成功，直接影响**该业务的收入、市场份额或用户增长**。",
      company_level: "公司级别影响：此职位的工作将对**公司的整体战略、财务状况或市场声誉产生重要影响**，其成败关系到公司的长期发展和核心竞争力。",
    },
